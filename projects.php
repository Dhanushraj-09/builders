<?php
/**
 * Projects Page — StructuraPro Builders
 */
                ...
                <a href="<?= SITE_URL ?>/project-detail.php?slug=<?= urlencode($project['slug']) ?>" class="block project-card group">
                    <div class="aspect-[4/3] overflow-hidden rounded-2xl relative">
                        ...
                        <div class="absolute top-4 right-4">
                            <span class="bg-dark-900/80 backdrop-blur text-primary-400 text-xs font-semibold px-2 py-1 rounded-lg flex items-center gap-1">
