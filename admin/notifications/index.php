            ...
            <tr>
                ...
                <td>
                    <div class="flex items-center gap-2">
                        ...
                        <a href="<?= SITE_URL ?>/admin/notifications/delete.php?id=<?= $n[&token=<?= generate_csrf_token() ?>'id'] ?>&token=<?= generate_csrf_token() ?>" onclick="return confirm('Delete?')" class="w-8 h-8 rounded-lg bg-red-500/10 flex items-center justify-center text-red-400 hover:bg-red-500/20"><i class="fa-solid fa-trash text-xs"></i></a>
                    </div>
                </td>
            </tr>
            <?php endforeach; ?>
